         ...
         <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-content">
                                ...
                                <?php echo form_open(base_url("admin/proyectos/contenidos/editar/$datos->slug"), ["role"=>"form", "enctype"=>"multipart/form-data", "method"=>"POST"]) ?>
            ...
            <div class="footer">
                <div class="float-right">
                    ...
                    <input type="hidden" name="cat" value="contenidos">
                </div>
                <div>
