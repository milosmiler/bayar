         ...
         <div id="page-wrapper" class="gray-bg dashbard-1">
                    ...
                    <div class="col-lg-12">
                        <div class="ibox">
                            <div class="ibox-content">
                                ...
                                <?php echo form_open(base_url("admin/proyectos/tecnologia/editar/$datos->slug"), ["role"=>"form", "enctype"=>"multipart/form-data", "method"=>"POST"]) ?>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-4 col-sm-offset-2">
                                            ...
                                            <input class="btn btn-primary btn-sm delete" style="background: red; border: red 1px solid" type="submit" formaction="/bayarp/admin/proyectos/tecnologia/eliminar/<?= $datos->slug ?>" name="submit" value="Delete">
                                        </div>
                                    </div>
                                <?php echo form_close() ?>
                            </div>
            ...
            <div class="footer">
                <div class="float-right">
                    ...
                    <input type="hidden" name="cat" value="tecnologia">
                </div>
                <div>
