...
Class Tacticas_Model extends CI_Model {
	...
	{
		return $this->db->get("tacticas");
	}

    public function getAllPropertiesOnly($slug)
    {
        return $this->db->get_where("tacticas", array("slug" => $slug))->row();
    }

    public function eliminarEvent($slug)
    {
        $this->db->where('slug', $slug);
        $this->db->delete('tacticas');
    ...
    public function insertAllProperties($dataTools, $dataup)
    {
        ...
        $this->db->where("tact_id", $ultimoId);
    ...
    public function updateAllProperties($dataTools, $dataup, $slug)
    {
        ...
        $slug = $this->createSlug($dataTools["titulo"], $dd->tact_id);
        ...
        $this->db->set($data);
        $this->db->where("tact_id", $dd->tact_id);
        $this->db->update("tacticas");
