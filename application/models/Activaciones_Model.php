    ...
    public function updateAllProperties($dataTools, $dataup, $slug)
    {
        ...
        if ($imgsd1 == null) {
            ...
            if ($dd->imagend1 != $imgsd1) {
                @unlink('./uploads/post/activaciones/'.$dd->imagend1);
            }
        }
        ...
        if ($imgsd2 == null) {
            ...
            if ($dd->imagend2 != $imgsd2) {
                @unlink('./uploads/post/activaciones/'.$dd->imagend2);
            }
        }
        ...
        if ($imgsd3 == null) {
            ...
            if ($dd->imagend3 != $imgsd3) {
                @unlink('./uploads/post/activaciones/'.$dd->imagend3);
            }
        }
        ...
        if ($imgsd4 == null) {
            ...
            if ($dd->imagend4 != $imgsd4) {
                @unlink('./uploads/post/activaciones/'.$dd->imagend4);
            }
        }
        ...
        if ($imgsd5 == null) {
            ...
            if ($dd->imagend5 != $imgsd5) {
                @unlink('./uploads/post/activaciones/'.$dd->imagend5);
            }
        }
