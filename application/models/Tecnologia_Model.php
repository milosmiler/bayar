...
Class Tecnologia_Model extends CI_Model {
	...
	{
		return $this->db->get("tecnologia");
	}

    public function getAllPropertiesOnly($slug)
    {
        return $this->db->get_where("tecnologia", array("slug" => $slug))->row();
    }
    ...
    public function insertAllProperties($dataTools, $dataup)
    {
        ...
        $this->db->where("tecno_id", $ultimoId);
    ...
    public function updateAllProperties($dataTools, $dataup, $slug)
    {
        ...
        $slug = $this->createSlug($dataTools["titulo"], $dd->tecno_id);
        ...
        $this->db->set($data);
        $this->db->where("tecno_id", $dd->tecno_id);
        $this->db->update("tecnologia");
